...
$('#total_sum').html('Total: ' + '<%= number_to_currency($currency_convert.new_amount_from_expense(@expense.amount, @expense.currency.name), unit: $currency_convert.convert_currency, delimiter: ' ', format: '%n %u') %>')
